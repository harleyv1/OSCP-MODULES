...
```shell
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/modules
...
```shell
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/scripts/
...
```shell
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/tools/

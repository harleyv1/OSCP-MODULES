...
```shell
Pwn1Sec@htb[/htb]$ searchsploit nagios3
...
```shell
Pwn1Sec@htb[/htb]$ searchsploit -t Nagios3 --exclude=".py"
...
```shell
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/
...
```shell
Pwn1Sec@htb[/htb]$ cp ~/Downloads/9861.rb /usr/share/metasploit-framework/modules/exploits/unix/webapp/nagios3_command_injection.rb
Pwn1Sec@htb[/htb]$ msfconsole -m /usr/share/metasploit-framework/modules/
```
...
```shell
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/modules/exploits/linux/http/ | grep bludit
...
```shell
Pwn1Sec@htb[/htb]$ cp ~/Downloads/48746.rb /usr/share/metasploit-framework/modules/exploits/linux/http/bludit_auth_bruteforce_mitigation_bypass.rb
```

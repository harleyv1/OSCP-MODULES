...
```shell-session
Pwn1Sec@htb[/htb]$ ls /usr/share/metasploit-framework/plugins
...
```shell-session
Pwn1Sec@htb[/htb]$ git clone https://github.com/darkoperator/Metasploit-Plugins
Pwn1Sec@htb[/htb]$ ls Metasploit-Plugins
...
```shell-session
Pwn1Sec@htb[/htb]$ sudo cp ./Metasploit-Plugins/pentest.rb /usr/share/metasploit-framework/plugins/pentest.rb
```

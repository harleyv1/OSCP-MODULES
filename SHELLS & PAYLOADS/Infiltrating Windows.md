...
```shell
Pwn1Sec@htb[/htb]$ ping 192.168.86.39 
...
```shell
Pwn1Sec@htb[/htb]$ sudo nmap -v -O 192.168.86.39
...
```shell
Pwn1Sec@htb[/htb]$ sudo nmap -v 192.168.86.39 --script banner.nse
...
```shell
Pwn1Sec@htb[/htb]$ nmap -v -A 10.129.201.97

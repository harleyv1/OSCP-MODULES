...
```shell
Pwn1Sec@htb[/htb]$ curl -s http://192.168.10.10
...
```shell
Pwn1Sec@htb[/htb]$ curl -s http://192.168.10.10 -H "Host: randomtarget.com"
...
```shell
Pwn1Sec@htb[/htb]$ cat ./vhosts | while read vhost;do echo "\n********\nFUZZING: ${vhost}\n********";curl -s -I http://192.168.10.10 -H "HOST: ${vhost}.randomtarget.com" | grep "Content-Length: ";done
...
```shell
Pwn1Sec@htb[/htb]$ curl -s http://192.168.10.10 -H "Host: dev-admin.randomtarget.com"
...
```shell
Pwn1Sec@htb[/htb]$ ffuf -w ./vhosts -u http://192.168.10.10 -H "HOST: FUZZ.randomtarget.com" -fs 612

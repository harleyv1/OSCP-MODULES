...
```shell
Pwn1Sec@htb[/htb]$ nslookup -type=NS zonetransfer.me
...
```shell
Pwn1Sec@htb[/htb]$ nslookup -type=any -query=AXFR zonetransfer.me nsztm1.digi.ninja
...
Pwn1Sec@htb[/htb]$ export NS="d.ns.facebook.com"
Pwn1Sec@htb[/htb]$ export WORDLIST="numbers.txt"
Pwn1Sec@htb[/htb]$ gobuster dns -q -r "${NS}" -d "${TARGET}" -w "${WORDLIST}" -p ./patterns.txt -o "gobuster_${TARGET}.txt"

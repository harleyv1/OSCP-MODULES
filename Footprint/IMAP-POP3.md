...
#### Nmap :
```shell
Pwn1Sec@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
...
#### cURL :
```shell
Pwn1Sec@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
...
```shell
Pwn1Sec@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
...
```shell
Pwn1Sec@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
...
```shell
Pwn1Sec@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
